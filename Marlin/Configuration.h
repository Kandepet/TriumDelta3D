...
#define STRING_CONFIG_H_AUTHOR "(EMERGIN)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "TRIUM3D"
...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 278.0 // mm
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {160, 160, 160, 192}  // default steps per unit for Kossel (GT2, 20 tooth)
#define DEFAULT_MAX_FEEDRATE          {200, 200, 200, 200}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {1500,1500,1500,1500}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
...
#define DEFAULT_EJERK                 20.0     // (mm/sec) //5.0
